...
# #### Test data
fname_test = "test_flow_stats.csv"
pd_test = pd.read_csv(folder + fname_test)
...
dump(best_fit_model, 'network_model.joblib')
...
for feature in colsPerTime:
    pd_test[feature + "PerTime"] = pd_test[feature] / pd_test["flowDuration"]
pd_test = pd_test[feature_cols]

predictions = best_fit_model.predict(pd_test)
target_class = 0
